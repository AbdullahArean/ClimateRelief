package com.arean.ClimateRelief.model.db;
...
import com.arean.ClimateRelief.databinding.MultipleDaysItemBinding;
import com.arean.ClimateRelief.utils.AppUtil;
import com.arean.ClimateRelief.utils.Constants;
import com.arean.ClimateRelief.utils.DateConverter;
...
public class MultipleDaysWeather extends AbstractItem<MultipleDaysWeather, MultipleDaysWeather.MyViewHolder> {
  ...
  protected static class MyViewHolder extends FastAdapter.ViewHolder<MultipleDaysWeather> {
    Context context;
    View view;
    final MultipleDaysItemBinding binding;
